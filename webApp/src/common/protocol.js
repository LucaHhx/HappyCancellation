(function ( ByteArray) {
   ...
   * client decode
   * msg String data
   * return Protocol.Message Object
   */
  ...
  /**
   * Protocol.Package protocol encode.
   *
   ...
   */
  Protocol.Package.encode = function(type, body){
  ...
  /**
   * Protocol.Package protocol decode.
   * See encode for package format.
   *
   * @param  {ByteArray} buffer byte array containing package content
   * @return {Object}           {type: package type, buffer: body byte array}
   */
  Protocol.Package.decode = function(buffer){
    var offset = 0;
    var bytes = new ByteArray(buffer);
    var length = 0;
    var rs = [];
  ...
  /**
   * Protocol.Message protocol encode.
   *
   ...
   */
  Protocol.Message.encode = function(id, type, compressRoute, route, msg){
  ...
  /**
   * Protocol.Message protocol decode.
   *
   * @param  {Buffer|Uint8Array} buffer message bytes
   * @return {Object}            message object
   */
  Protocol.Message.decode = function(buffer) {
    var bytes =  new ByteArray(buffer);
